...
class SteamApp(SteamObject):
    ...
    def achievements(self):
        ...
        if self._userid is not None:
            ...
            _playerresponse = APIConnection().call("ISteamUserStats",
            ...
            userid = None
            unlocks = None
            _playerresponse = None
        achievements_list = []
        for achievement in self._schema.game.availableGameStats.achievements:
            achievement_obj = SteamAchievement(self._id, achievement.name, achievement.displayName, self._userid, self._schema, _playerresponse)
...
class SteamAchievement(SteamObject):
    def __init__(self, linked_appid, apiname, displayname, linked_userid=None, game_schema=None, _playerresponse=None):
        """
        ...
        self._response = game_schema
        self._playerresponse = _playerresponse
    ...
    def description(self):
        for achievement in self._response.game.availableGameStats.achievements:
    ...
    def is_unlocked(self):
        if self._userid is None:
            return False
        for achievement in self._playerresponse.playerstats.achievements:
